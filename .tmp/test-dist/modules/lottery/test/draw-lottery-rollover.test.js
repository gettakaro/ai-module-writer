...
describe('lottery: draw-lottery rolloverOnCancel', () => {
    ...
    it('should roll over pot when rolloverOnCancel=true and insufficient participants', async () => {
        ...
        assert.equal(currencyAfterDraw, currencyBeforeDraw, `Expected player currency unchanged (no refund when rolloverOnCancel=true). Before: ${currencyBeforeDraw}, After: ${currencyAfterDraw}`);
